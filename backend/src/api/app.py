...
# Flask application factory for AI Profanity Filter.
# Creates and configures the Flask application with proper error handling and CORS.
def create_app(config: 'AppConfig') -> Flask:
    ...
    app.config['PROCESSED_FOLDER'] = config.processed_dir
