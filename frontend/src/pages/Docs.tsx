        ...
        return (
          <div className="space-y-8">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Get up and running with Censorly in just a few minutes.
              </p>
            </div>

            <div className="space-y-6">
              <div className="border-l-4 border-blue-500 pl-6">
                <h3 className="text-lg font-semibold mb-2">Step 1: Create an Account</h3>
                <p className="text-gray-600 mb-3">
                  Sign up for a free account to get access to our API and dashboard.
                </p>
                <Link 
                  to="/signup" 
              ...
              <div className="border-l-4 border-green-500 pl-6">
                <h3 className="text-lg font-semibold mb-2">Step 2: Get Your API Key</h3>
                <p className="text-gray-600 mb-3">
              ...
              <div className="border-l-4 border-purple-500 pl-6">
                <h3 className="text-lg font-semibold mb-2">Step 3: Make Your First Request</h3>
                <p className="text-gray-600 mb-3">
                  Use our API to filter your first piece of content.
                </p>
                <div className="bg-gray-900 text-white p-4 rounded-lg font-mono text-sm overflow-x-auto">
                  <div className="text-green-400 mb-2"># Create a text analysis job</div>
                  <div>curl -X POST https://ai-profanity-filter.onrender.com/api/jobs \\</div>
                  <div className="ml-4">-H "Authorization: Bearer YOUR_JWT_TOKEN" \\</div>
                  <div className="ml-4">-H "Content-Type: application/json" \\</div>
                  <div className="ml-4">-d '{`{`}</div>
                  <div className="ml-8">"content": "Your text content here",</div>
                  <div className="ml-8">"job_type": "text_analysis"</div>
                  <div className="ml-4">{`}`}'</div>
                </div>
              </div>
            </div>
        ...
        return (
          <div className="space-y-8">
            <div>
              <h1 className="text-4xl font-bold text-gray-900 mb-4">Authentication</h1>
              <p className="text-xl text-gray-600 mb-8">
                Learn how to authenticate your requests to the Censorly API.
              </p>
            </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-semibold text-yellow-900">Important Security Note</h3>
              </div>
              <p className="text-yellow-800">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-semibold mb-4">JWT Token Authentication</h3>
                <p className="text-gray-600 mb-4">
                  All API requests must include your JWT token in the Authorization header. Get your token by logging in:
                </p>
                <div className="bg-gray-900 text-white p-4 rounded-lg font-mono text-sm">
                  <div className="text-blue-400">Authorization: Bearer YOUR_JWT_TOKEN</div>
                </div>
              </div>

              <div>
                <h3 className="text-xl font-semibold mb-4">Getting Your JWT Token</h3>
                <p className="text-gray-600 mb-4">
                  Login to get your JWT token:
                </p>
                <div className="bg-gray-900 text-white p-4 rounded-lg font-mono text-sm">
                  <div className="text-green-400 mb-2"># Login to get JWT token</div>
                  <div>curl -X POST https://ai-profanity-filter.onrender.com/api/auth/login \\</div>
                  <div className="ml-4">-H "Content-Type: application/json" \\</div>
                  <div className="ml-4">-d '{`{`}</div>
                  <div className="ml-8">"email": "your-email@example.com",</div>
                  <div className="ml-8">"password": "your-password"</div>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <div className="space-y-2 font-mono text-sm">
                    <div><span className="text-blue-600">Authorization:</span> Bearer YOUR_JWT_TOKEN</div>
                    <div><span className="text-blue-600">Content-Type:</span> application/json</div>
                    <div><span className="text-blue-600">Accept:</span> application/json</div>
                  </div>
                </div>
              </div>
            </div>
